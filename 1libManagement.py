...
Author.add_author("J.K. Rowling", "Vicious transphobe")

# Ask user if they want a base library. Remove these added books later

print("Welcome to the Library Management System! ")
tempuser = input("Please log in. Enter your username: ")
while True:
    tempid = input("Enter your library ID: ")
    if tempid.isdigit():
        User.add_user(tempuser, tempid)
        User.current_user = tempuser
        break
    else:
